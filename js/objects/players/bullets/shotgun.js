class Shotgun {
 constructor(x, y, player) {
  ...
  this.bullet = [document.createElement('div'), document.createElement('div'), document.createElement('div'), document.createElement('div'), document.createElement('div')]
  this.bulletOwner = player
 }
 load() {
  for (let i = 0; i < this.bullet.length; i++) {
   let spreadShift = Math.floor((Math.random() * 16) - 8)
   this.create(spreadShift, i)
  }
 }
 create(shift, i) {
